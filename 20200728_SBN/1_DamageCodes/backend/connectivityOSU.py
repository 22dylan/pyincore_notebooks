...
class TransConnectivity(BaseAnalysis):
	def run(self):
		...
		bldg2netwrk_df = pd.read_csv('../bldgs2trns_Seaside.csv')	# note: upload these to dataserver
...
class EPNConnectivity(BaseAnalysis):
	...
	def run(self):
		...
		# bldg2netwrk_df = pd.DataFrame(bldg2netwrk_df.get_inventory_reader())
		# bldg2netwrk_df = pd.DataFrame(list(bldg2netwrk_df['properties']))	
		bldg2netwrk_df = pd.read_csv('../bldgs2epn_Seaside.csv')	# note: upload these to dataserver
...
class WterConnectivity(BaseAnalysis):
	def WterConn_run(self):
		...
		# bldg2netwrk_df = pd.DataFrame(bldg2netwrk_df.get_inventory_reader())
		# bldg2netwrk_df = pd.DataFrame(list(bldg2netwrk_df['properties']))	
		bldg2netwrk_df = pd.read_csv('../bldgs2wter_Seaside.csv')	# note: upload these to dataserver
